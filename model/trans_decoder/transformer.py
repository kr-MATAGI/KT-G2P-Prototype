...
class TransformerS2Model(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, source_dict, target_dict):
        ...
        return TransformerS2Model(encoder, decoder, bert_encoder, src_berttokenizer, args.mask_cls_sep, args)
    ...
    def forward(self, src_tokens, src_lengths, bert_encoder_out):
        ...
        for layer in self.layers:
            x = layer(x, encoder_padding_mask, bert_encoder_out['bert_encoder_out'],
                      bert_encoder_out['bert_encoder_padding_mask'].bool())
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        bert_gates = getattr(args, 'bert_gates', [1])
        bert_gates = [x == 1 for x in bert_gates]
...
class ElectraFusedNATDecoder(FairseqNATDecoder):
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        super().__init__(
    ...
    def forward_length(self, normalize, encoder_out):
        ...
        # print(enc_feats.size()) # torch.Size([256, 16, 512])
        src_masks = encoder_out['encoder_padding_mask'].long()  # B x T or None
        # print(src_masks.size()) # torch.Size([16, 256])
    ...
    def extract_features(
        ...
        **unused
        ...
        if embedding_copy:
            ...
            src_embd = encoder_out["encoder_out"][0]
...
# 2023.04.11 - JAEHOON
#======================================================================
class ElectraPosAttnDecoder(FairseqNATDecoder):
#======================================================================
    """
    Transformer decoder consisting of *args.decoder_layers* layers. Each layer
    is a :class:`TransformerDecoderLayer`.
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.embed_dim = args.decoder.embed_dim
        self.embed_tokens = embed_tokens
    ...
    def forward(self,
        normalize,
        prev_output_tokens, encoder_out=None,
        bert_encoder_out=None, **unused
    ):
        features, _ = self.extract_features(
            prev_output_tokens,
            encoder_out,
    ...
    def extract_features(
        ...
        ''' embedding copy가 원래 소스코드에 있는데 사용하지 않음'''

        features, _ = self.forward_embedding(prev_output_tokens)

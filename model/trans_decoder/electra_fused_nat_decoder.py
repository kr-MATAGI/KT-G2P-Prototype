...
from model.bert_fused.fairseq_model import FairseqEncoderDecoderModel
...
from model.bert_fused.transformer import ElectraFusedNATDecoder
...
class ElectraNonDecoderFused(nn.Module):
    def __init__(self, decoder, bertencoder, berttokenizer, mask_cls_sep=False, args=None):
        ...
        #
        self.jaso_pair_dict = {}
        with open("./data/data_busan/filter_dict/jaso_filter.json", mode="r", encoding="utf-8") as f:
    ...
    def build_model(cls, args, source_dict, target_dict):
        ...
        return ElectraNonDecoderFused(decoder, bert_encoder, src_berttokenizer, args.mask_cls_sep, args)

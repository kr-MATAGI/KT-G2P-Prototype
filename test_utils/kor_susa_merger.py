...
#=================================================================
    ...
    def make_merged_kor_susa_npy_for_lstm(
        ...
        # Susa Tokenization
        train_susa_npy_dict = self._susa_tokenization(susa_src_data=train_susa_src_data,
                                                      susa_tgt_data=train_susa_tgt_data,
                                                      custom_vocab=custom_vocab, mode='train')
        dev_susa_npy_dict = self._susa_tokenization(susa_src_data=dev_susa_src_data,
                                                    susa_tgt_data=dev_susa_tgt_data,
                                                    custom_vocab=custom_vocab, mode='dev')
        test_susa_npy_dict = self._susa_tokenization(susa_src_data=test_susa_src_data,
...
if '__main__' == __name__:
    ...
    kor_susa_merger.make_merged_kor_susa_npy_for_lstm(
        ...
        npy_save_path='../data/susa_kor/lstm'
    )